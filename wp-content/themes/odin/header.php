...
<head>
	...
	<![endif]-->
	<?php wp_head(); ?>
	<script type="application/javascript" src="<?php echo get_template_directory_uri(); ?>/assets/js/scripts.js"></script>
</head>
	...
	<header id="header" role="banner">
		<div class="container">
			<div class="page-header hidden-xs">
				<div class="promo">
					<img src="/altran2/wp-content/uploads/2016/03/teste-abril.jpg"/>
				</div>
			...
			<div id="main-navigation" class="navbar navbar-default">
				...
				<nav class="collapse navbar-collapse navbar-main-navigation" role="navigation">
					...
					<form method="get" class="navbar-form navbar-right" action="<?php echo esc_url( home_url( '/' ) ); ?>" role="search">
						...
						<button type="submit" class="lupinha"></button>
					</form>
				</nav><!-- .navbar-collapse -->
				<a href="#" class="primeiro"><small>+</small>Acessados</a>
				<?php
				wp_nav_menu(
						array(
